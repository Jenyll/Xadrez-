...
namespace propPecas
{
    class PartidaDeXadrez
    {
        ...
        // todas as peças dessa cor, exceto, as pessas capturadas dessa cor.(pr pegar todas as peças q ainda estao em jogo).
        ...
        // Testa todas o movimento de todas as peças.
        public bool estaemXeque(Cor cor)
        {
            Peca R = rei(cor);
            if (R == null)
            {
                throw new TabException("Não tem Rei");
            }
        ...
        public void validarPosicaoOrigem(Posicao pos)
        {
            ...
            {
                throw new TabException("Não há movimentos possiveis para a peça de origem!");
            }
        }
